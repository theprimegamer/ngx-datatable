...
import * as import0 from './header-cell-filter.component';
...
export class Wrapper_DataTableHeaderCellFilterComponent {
  ...
  check_minCharacterFilter(currValue:any,throwOnChange:boolean,forceUpdate:boolean):void {
    if ((forceUpdate || import3.checkBinding(throwOnChange,this._expr_4,currValue))) {
      this._changed = true;
      this.context.minCharacterFilter = currValue;
