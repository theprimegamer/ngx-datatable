...
export class Wrapper_DatatableComponent {
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean,emit2:boolean,emit3:boolean,emit4:boolean,emit5:boolean,emit6:boolean,emit7:boolean,emit8:boolean):void {
    ...
    if (emit5) { (this.subscription5 = this.context.page.subscribe(_eventHandler.bind(view,'page'))); }
...
class View_DatatableComponent1 extends import2.AppView<any> {
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    var disposable_0:Function = import3.subscribeToRenderElement(this,this._el_0,new import3.InlineArray16(10,'sort',(null as any),'resize',(null as any),'reorder',(null as any),'select',(null as any),'filter',(null as any)),this.eventHandler(this.handleEvent_0));
    this._DataTableHeaderComponent_0_3.subscribe(this,this.eventHandler(this.handleEvent_0),true,true,true,true,true);
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_0_0_10:any = this.parentView.context.minFilterLength;
    this._DataTableHeaderComponent_0_3.check_minFilterLength(currVal_0_0_10,throwOnChange,false);
    const currVal_0_0_11:any = this.parentView.context.headerHeight;
    this._DataTableHeaderComponent_0_3.check_headerHeight(currVal_0_0_11,throwOnChange,false);
    const currVal_0_0_12:any = this.parentView.context.columns;
    this._DataTableHeaderComponent_0_3.check_columns(currVal_0_0_12,throwOnChange,false);
  ...
  handleEvent_0(eventName:string,$event:any):boolean {
    ...
    if ((eventName == 'filter')) {
      const pd_sub_4:any = ((<any>this.parentView.context.filtersChanged($event)) !== false);
