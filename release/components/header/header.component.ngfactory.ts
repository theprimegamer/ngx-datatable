...
import * as import27 from '../../../../build/components/header/header-cell-filter.component';
import * as import28 from './header-cell-filter.component.ngfactory';
import * as import29 from '../../directives/orderable.directive.ngfactory';
import * as import30 from '@angular/core/src/linker/query_list';
import * as import31 from '../../../../build/directives/orderable.directive';
export class Wrapper_DataTableHeaderComponent {
  ...
  checkHost(view:import2.AppView<any>,componentView:import2.AppView<any>,el:any,throwOnChange:boolean):void {
    const currVal_13:any = this.context.headerHeight;
    if (import3.checkBinding(throwOnChange,this._expr_13,currVal_13)) {
      view.renderer.setElementStyle(el,'height',((view.viewUtils.sanitizer.sanitize(import4.SecurityContext.STYLE,currVal_13) == null)? (null as any): view.viewUtils.sanitizer.sanitize(import4.SecurityContext.STYLE,currVal_13).toString()));
      this._expr_13 = currVal_13;
    }
    const currVal_14:any = this.context.headerWidth;
    if (import3.checkBinding(throwOnChange,this._expr_14,currVal_14)) {
      view.renderer.setElementStyle(el,'width',((view.viewUtils.sanitizer.sanitize(import4.SecurityContext.STYLE,currVal_14) == null)? (null as any): view.viewUtils.sanitizer.sanitize(import4.SecurityContext.STYLE,currVal_14).toString()));
  ...
  subscribe(view:import2.AppView<any>,_eventHandler:any,emit0:boolean,emit1:boolean,emit2:boolean,emit3:boolean,emit4:boolean):void {
    ...
    if (emit4) { (this.subscription4 = this.context.filter.subscribe(_eventHandler.bind(view,'filter'))); }
  }
}
...
class View_DataTableHeaderComponent4 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import27.DataTableHeaderCellFilterComponent>;
  _ResizeableDirective_0_3:import12.Wrapper_ResizeableDirective;
  _DataTableHeaderCellFilterComponent_0_4:import28.Wrapper_DataTableHeaderCellFilterComponent;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import15.ViewContainer) {
    super(View_DataTableHeaderComponent4,renderType_DataTableHeaderComponent,import7.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),'datatable-header-cell-filter',new import3.InlineArray2(2,'resizeable',''),(null as any));
    this.compView_0 = new import28.View_DataTableHeaderCellFilterComponent0(this.viewUtils,this,0,this._el_0);
    this._ResizeableDirective_0_3 = new import12.Wrapper_ResizeableDirective(new import16.ElementRef(this._el_0));
    this._DataTableHeaderCellFilterComponent_0_4 = new import28.Wrapper_DataTableHeaderCellFilterComponent();
    this._text_1 = this.renderer.createText((null as any),'\n        ',(null as any));
    this.compView_0.create(this._DataTableHeaderCellFilterComponent_0_4.context);
    var disposable_0:Function = import3.subscribeToRenderElement(this,this._el_0,new import3.InlineArray8(8,'resize',(null as any),'select',(null as any),'filter',(null as any),'mousedown',(null as any)),this.eventHandler(this.handleEvent_0));
    this._ResizeableDirective_0_3.subscribe(this,this.eventHandler(this.handleEvent_0),true);
    this._DataTableHeaderCellFilterComponent_0_4.subscribe(this,this.eventHandler(this.handleEvent_0),true,true);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [
      this._el_0,
      this._text_1
    ]
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import18.ResizeableDirective) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ResizeableDirective_0_3.context; }
    if (((token === import27.DataTableHeaderCellFilterComponent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._DataTableHeaderCellFilterComponent_0_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    const currVal_0_0_0:any = this.context.$implicit.resizeable;
    this._ResizeableDirective_0_3.check_resizeEnabled(currVal_0_0_0,throwOnChange,false);
    this._ResizeableDirective_0_3.ngDoCheck(this,this._el_0,throwOnChange);
    const currVal_0_1_0:any = this.context.$implicit;
    this._DataTableHeaderCellFilterComponent_0_4.check_column(currVal_0_1_0,throwOnChange,false);
    const currVal_0_1_1:any = this.parentView.parentView.context.headerHeight;
    this._DataTableHeaderCellFilterComponent_0_4.check_headerHeight(currVal_0_1_1,throwOnChange,false);
    const currVal_0_1_2:any = this.parentView.parentView.context.minFilterLength;
    this._DataTableHeaderCellFilterComponent_0_4.check_minFilterLength(currVal_0_1_2,throwOnChange,false);
    this._DataTableHeaderCellFilterComponent_0_4.ngDoCheck(this,this._el_0,throwOnChange);
    this._ResizeableDirective_0_3.checkHost(this,this.compView_0,this._el_0,throwOnChange);
    this._DataTableHeaderCellFilterComponent_0_4.checkHost(this,this.compView_0,this._el_0,throwOnChange);
    this.compView_0.internalDetectChanges(throwOnChange);
    if (!throwOnChange) { if ((this.numberOfChecks === 0)) { this._ResizeableDirective_0_3.context.ngAfterViewInit(); } }
  }
  destroyInternal():void {
    this.compView_0.destroy();
    this._ResizeableDirective_0_3.ngOnDestroy();
    this._DataTableHeaderCellFilterComponent_0_4.ngOnDestroy();
  }
  visitRootNodesInternal(cb:any,ctx:any):void {
    cb(this._el_0,ctx);
  }
  handleEvent_0(eventName:string,$event:any):boolean {
    this.markPathToRootAsCheckOnce();
    var result:boolean = true;
    result = (this._ResizeableDirective_0_3.handleEvent(eventName,$event) && result);
    if ((eventName == 'resize')) {
      const pd_sub_0:any = ((<any>this.parentView.parentView.context.onColumnResized($event,this.context.$implicit)) !== false);
      result = (pd_sub_0 && result);
    }
    if ((eventName == 'select')) {
      const pd_sub_1:any = ((<any>this.parentView.parentView.context.select.emit($event)) !== false);
      result = (pd_sub_1 && result);
    }
    if ((eventName == 'filter')) {
      const pd_sub_2:any = ((<any>this.parentView.parentView.context.filterChanged($event)) !== false);
      result = (pd_sub_2 && result);
    }
    return result;
  }
}
class View_DataTableHeaderComponent3 extends import2.AppView<any> {
  _el_0:any;
  _NgStyle_0_3:import20.Wrapper_NgStyle;
  _text_1:any;
  _anchor_2:any;
  ...
  /*private*/ _expr_8:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any,declaredViewContainer:import15.ViewContainer) {
    super(View_DataTableHeaderComponent3,renderType_DataTableHeaderComponent,import7.ViewType.EMBEDDED,viewUtils,parentView,parentIndex,parentElement,import8.ChangeDetectorStatus.CheckAlways,declaredViewContainer);
    this._expr_8 = import1.UNINITIALIZED;
  }
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    this._el_0 = import3.createRenderElement(this.renderer,(null as any),'div',import3.EMPTY_INLINE_ARRAY,(null as any));
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    if ((nodeIndex == 2)) { return new View_DataTableHeaderComponent4(this.viewUtils,this,2,this._anchor_2,this._vc_2); }
    return (null as any);
  }
}
...
export class View_DataTableHeaderComponent0 extends import2.AppView<import0.DataTableHeaderComponent> {
  _text_0:any;
  _el_1:any;
  _OrderableDirective_1_3:import29.Wrapper_OrderableDirective;
  _query_DraggableDirective_1_0:import30.QueryList<any>;
  _text_2:any;
  _anchor_3:any;
  ...
  _NgFor_8_6:import21.Wrapper_NgFor;
  _text_9:any;
  _text_10:any;
  ...
  createInternal(rootSelector:string):import9.ComponentRef<any> {
    ...
    this._OrderableDirective_1_3 = new import29.Wrapper_OrderableDirective(this.parentView.injectorGet(import22.KeyValueDiffers,this.parentIndex));
    this._query_DraggableDirective_1_0 = new import30.QueryList<any>();
    ...
    this._el_6 = import3.createRenderElement(this.renderer,parentRenderNode,'div',new import3.InlineArray2(2,'class','datatable-header-inner'),(null as any));
    this._text_7 = this.renderer.createText(this._el_6,'\n      ',(null as any));
    this._anchor_8 = this.renderer.createTemplateAnchor(this._el_6,(null as any));
    this._vc_8 = new import15.ViewContainer(8,6,this,this._anchor_8);
    this._TemplateRef_8_5 = new import23.TemplateRef_(this,8,this._anchor_8);
    this._NgFor_8_6 = new import21.Wrapper_NgFor(this._vc_8.vcRef,this._TemplateRef_8_5,this.parentView.injectorGet(import24.IterableDiffers,this.parentIndex),this.ref);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import31.OrderableDirective) && ((1 <= requestNodeIndex) && (requestNodeIndex <= 4)))) { return this._OrderableDirective_1_3.context; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_8_0_0:any = this.context.columnsByPin;
    this._NgFor_8_6.check_ngForOf(currVal_8_0_0,throwOnChange,false);
    const currVal_8_0_1:any = this.context.trackByGroups;
    this._NgFor_8_6.check_ngForTrackBy(currVal_8_0_1,throwOnChange,false);
    ...
    const currVal_19:any = this.context.columnGroupWidths.total;
    if (import3.checkBinding(throwOnChange,this._expr_19,currVal_19)) {
      this.renderer.setElementStyle(this._el_1,'width',((this.viewUtils.sanitizer.sanitize(import4.SecurityContext.STYLE,currVal_19) == null)? (null as any): (this.viewUtils.sanitizer.sanitize(import4.SecurityContext.STYLE,currVal_19).toString() + 'px')));
      this._expr_19 = currVal_19;
    }
    const currVal_20:any = this.context.columnGroupWidths.total;
    if (import3.checkBinding(throwOnChange,this._expr_20,currVal_20)) {
      this.renderer.setElementStyle(this._el_6,'width',((this.viewUtils.sanitizer.sanitize(import4.SecurityContext.STYLE,currVal_20) == null)? (null as any): (this.viewUtils.sanitizer.sanitize(import4.SecurityContext.STYLE,currVal_20).toString() + 'px')));
  ...
  createEmbeddedViewInternal(nodeIndex:number):import2.AppView<any> {
    ...
    if ((nodeIndex == 8)) { return new View_DataTableHeaderComponent3(this.viewUtils,this,8,this._anchor_8,this._vc_8); }
    return (null as any);
  }
